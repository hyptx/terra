...
<?php $custom_sidebar_html = get_post_meta($post->ID,'ter_custom_sidebar_html',true) ?>
...
function ter_create_custom_sidebar_meta_box(){ new TerCustomSidebarMetaBox(); }

if(is_admin()){
    add_action('load-post.php','ter_create_custom_sidebar_meta_box');
    add_action('load-post-new.php','ter_create_custom_sidebar_meta_box');
}

class TerCustomSidebarMetaBox{
	...
	public function add_meta_box($post_type){
       if(in_array($post_type,$this->_enabled_post_types)) add_meta_box('ter_page_meta_box',__('Custom Sidebar HTML','terra'),array($this,'render_meta_box_content'),$post_type,'advanced','high');
    }
