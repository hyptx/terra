...
<article id="post-<?php the_ID() ?>" <?php post_class() ?>>
    ...
    <p class="alert alert-info"><strong>Image Post Format:</strong><br />This post format template is just a copy of the <em>content.php</em> file.<br />Please edit the <em>content-image.php</em> file to customize this template.</p>
